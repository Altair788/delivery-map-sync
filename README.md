...
Автоматизированная система визуализации логистических данных на карте.
...
1. Скопируйте [шаблон таблицы](examples/sample_sheet.csv) в Google Sheets
...
- 🗺️ [Живая карта](https://script.google.com/macros/s/.../exec)
- 📊 [Пример таблицы](https://docs.google.com/spreadsheets/d/.../edit) *(опционально, доступ только на просмотр)*
